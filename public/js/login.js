...
var url = document.head.querySelector('meta[name="base-url"]').content;
var api_key = 'TASYA-PRODUCTION';
var base_url = url;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__config_env_config__ = __webpack_require__(11);
...
var app = new Vue({
    ...
    methods: {
        login: function login() {
            axios.post(__WEBPACK_IMPORTED_MODULE_0__config_env_config__["b" /* base_url */] + 'oauth/token', {
                "client_id": 2,
                "client_secret": __WEBPACK_IMPORTED_MODULE_0__config_env_config__["a" /* api_key */],
                "grant_type": "password",
