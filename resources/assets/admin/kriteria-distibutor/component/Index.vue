<template>
	<div>
		<h5>
			...
			List Data Kriteria Distributor
		</h5>
		<div class="row">
		  <div class="col-lg-12">

			<div class="content-panel">
				<router-link class="btn btn-success pull-right" :to="{ name: 'create'}">Tambah Kriteria Distributor</router-link>
				<h4><i class="fa fa-users"></i> Data Kriteria Distributor</h4>
